...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.push(user.isOnboarded ? "/discover" : "/onboarding");
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-gray-900">WorldPals</span>
          </Link>
          <h1 className="text-2xl font-bold text-gray-900 mt-6 mb-2">Welcome back!</h1>
          <p className="text-gray-500">Sign in to continue your global journey</p>
        </div>
